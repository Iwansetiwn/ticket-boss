...
export const metadata: Metadata = {
  title: "Ticket Monitoring Buttons | Ticket Monitoring - Ticket Monitoring Dashboard Template",
  description:
    "This is Ticket Monitoring Buttons page for Ticket Monitoring - Ticket Monitoring Tailwind CSS Admin Dashboard Template",
};
