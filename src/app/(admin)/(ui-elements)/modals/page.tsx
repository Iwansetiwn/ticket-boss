...
export const metadata: Metadata = {
  title: "Ticket Monitoring Modals | Ticket Monitoring - Ticket Monitoring Dashboard Template",
  description:
    "This is Ticket Monitoring Modals page for Ticket Monitoring - Ticket Monitoring Tailwind CSS Admin Dashboard Template",
  // other metadata
};
