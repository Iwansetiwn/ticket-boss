...
export const metadata: Metadata = {
  title: "Ticket Monitoring Avatars | Ticket Monitoring - Ticket Monitoring Dashboard Template",
  description:
    "This is Ticket Monitoring Avatars page for Ticket Monitoring - Ticket Monitoring Tailwind CSS Admin Dashboard Template",
};
