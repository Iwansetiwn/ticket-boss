...
export const metadata: Metadata = {
  title: "Ticket Monitoring Badge | Ticket Monitoring - Ticket Monitoring Dashboard Template",
  description:
    "This is Ticket Monitoring Badge page for Ticket Monitoring - Ticket Monitoring Tailwind CSS Admin Dashboard Template",
  // other metadata
};
